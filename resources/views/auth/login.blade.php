...
@section('content')
    <div class="container">
        <div class="row justify-content-center mt-5">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">{{ __('nombres.login') }}</div>
                            ...
                            <div class="form-group row mb-0">
                                ...
                                <a href="{{ url('auth/google') }}"
                                   class="btn btn-outline-light  col-6 offset-3 mt-3 text-dark rounded-0 shadow">
                                    <img src="https://www.stickpng.com/assets/images/5847f9cbcef1014c0b5e48c8.png" style="width: 18px" class="mr-2 justify-content-start">
                                    <strong>{{__('nombres.login_google')}}</strong>
                                </a>
                            </div>
                        </form>
                    </div>
